...
const styles = StyleSheet.create({
  ...
  dayCloseDot: { width: 3, height: 3, borderRadius: 2, backgroundColor: colors.border.strong },
  dayCloseText: { ...type.serifQuote, fontSize: 16, lineHeight: 24, color: colors.ink.tertiary },
  fabWrap: {
    position: 'absolute',
